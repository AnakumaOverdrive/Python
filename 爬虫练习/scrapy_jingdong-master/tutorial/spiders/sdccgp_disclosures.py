...
#---------------------------------------------------------------------------
#山东中标结果
class sdccgpDisclosuresSpider(scrapy.Spider):
	name = "sdccgpDisclosures"
	...
	def getlist():
		...
		for i in range(1,581):
			seq.append("http://www.ccgp-shandong.gov.cn/sdgp2014/site/channelall.jsp?curpage="+str(i)+"&colcode=0302&subject=&pdate=")
		return seq;
	...
	def parse_details(self,response):
		...
		#print(filepath)
		opath = os.path.abspath("./山东中标结果/" + filepath) 
