...
#---------------------------------------------------------------------------
#新疆采购公告
class xjczNoticesSpider(scrapy.Spider):
	name = "xjczNotices"
	...
	def getlist():
		...
		#70
		for i in range(1,2):
			seq.append("http://zfcg.xjcz.gov.cn/djl/cmsPublishAction.do?method=selectCmsInfoPublishList&channelId=15&pagecount="+str(i))
		return seq;
	...
	def parse_details(self,response):
		...
		print(filepath)
		opath = os.path.abspath("./新疆采购公告/" + filepath) 
