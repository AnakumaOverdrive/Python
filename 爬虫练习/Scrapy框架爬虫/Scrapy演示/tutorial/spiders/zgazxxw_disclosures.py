...
#---------------------------------------------------------------------------
#石家庄采购公告
class zgazxxwDisclosuresSpider(scrapy.Spider):
	name = "zgazxxwDisclosures"
	...
	def getlist():
		...
		for i in range(0,201):
			seq.append("http://www.zgazxxw.com/he-012008l777-"+str(i)+".html")
		return seq;
	...
	def parse(self,response):
		...
		print(response.url)
		req = []
		for sel in response.xpath('//a[contains(@href, "zbpd/zhongbgg/")]'):
	...
	def parse_details(self,response):
		...
		#print(filepath)
		opath = os.path.abspath("./石家庄中标结果/" + filepath) 
