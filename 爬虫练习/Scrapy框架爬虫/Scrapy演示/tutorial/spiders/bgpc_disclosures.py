...
#---------------------------------------------------------------------------
#北京采购公告
class bgpcDisclosuresSpider(scrapy.Spider):
	name = "bgpcDisclosures"
	allowed_domains = ["bgpc.gov.cn"]
	
	def getlist():
		seq = []
		for i in range(1,119):
			seq.append("http://www.bgpc.gov.cn/news/news/nt_id/32/page/"+str(i))
		return seq;
	...
	def parse_details(self,response):
		...
		opath = os.path.abspath("./北京中标公告/" + filepath) 
