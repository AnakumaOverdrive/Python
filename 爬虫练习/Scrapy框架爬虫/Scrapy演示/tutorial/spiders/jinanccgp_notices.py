...
#---------------------------------------------------------------------------
#济南采购公告
class jinanccgpNoticesSpider(scrapy.Spider):
	name = "jinanccgpNotices"
	...
	def getlist():
		...
		for i in range(1,1971):
			seq.append("http://www.ccgp-jinan.gov.cn/jngp/site/list.jsp?curpage="+str(i)+"&colid=37")
		return seq;
	...
	def parse_details(self,response):
		...
		#print(filepath)
		opath = os.path.abspath("./济南采购公告/" + filepath) 
